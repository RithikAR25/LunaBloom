...
import type { PhaseSymptomTrends } from '../../models/Insights';
import { InsightEngine } from '../../services/InsightEngine';

export class GetSymptomTrends {
  ...
  public async execute(): Promise<PhaseSymptomTrends[]> {
    ...
    return this.insightEngine.getSymptomTrends(logs, cycles, profile?.avgCycleLength);
  }
}
